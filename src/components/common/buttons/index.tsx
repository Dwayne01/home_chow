	...
	return (
		<button
			...
			className={classNames(
				rootClass || "",
				" p-3 rounded-[10px] flex justify-center items-center hover:text-primary-color hover:border hover:border-primary-color hover:outline-primary-color-light focus:outline-none  focus:ring-4 focus:ring-primary-color-light",
