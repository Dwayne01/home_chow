		...
		<section className="flex-col items-center gap-12 px-10">
				<div className=" items-center justify-between gap-4 md:flex">
					<Image
						...
						className=" md:w-[500px] md:h-[402px]"
						alt="stella"
					/>
					...
					<div className="flex-col gap-[18px] md:w-[480px] md:h-[136px]">
						...
						<h2 className="font-normal text-base text-dark-gray-300 ">
							...
							ornare a faucibus morbi morbi. Posuere vitae neque volutpat
							mauris. Auctor pharetra montes aliquet.
						</h2>
					</div>
				</div>
				...
				<div className=" items-center  justify-between gap-4 md:flex">
					...
					<Image
						...
						className=" md:w-[456px] md:h-[456px]"
						alt="signup"
					/>
				</div>
