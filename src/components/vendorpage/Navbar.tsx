    ...
    return (
        ...
        <div className="flex w-[95%] mt-[12px] ml-[20px] items-center justify-between flex-wrap z-auto gap-3">
          ...
          <div className='flex items-center gap-3'>
            ...
            <Image width={143} height={34} src="/assets/images/logo/HomeChow_Logo.png" className="hidden sm:block  left-5 top-3 absolute cursor-pointer" alt="logo" />
            <Image width={31.43} height={32.85} src="/assets/images/logo/minilogo.png" className=" block sm:hidden  cursor-pointer " alt="logo" />
          </div>
          ...
          <div className="flex flex-wrap gap-3 items-center justify-end top-3">
            ...
            <div className="flex items-center gap-1 ">
              ...
              <div className='hidden sm:block'>
               <button className="flex items-center justify-center bg-[#EAEAEA] p-2 gap-1 rounded-lg ">$12,567.00 <FiEye /></button>
              </div>
            </div>
