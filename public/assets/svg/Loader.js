const Loader = ({
  ...
  <svg width={"50px"}
      ...
      <rect x="21" y="30" width="8" height="40" fill="currentColor">
    ...
    <rect x="46" y="30" width="8" height="40" fill="currentColor">
    ...
    <rect x="71" y="30" width="8" height="40" fill="currentColor">
